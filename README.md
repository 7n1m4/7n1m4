...
<a href="https://github.com/7n1m4/7n1m4#%EF%B8%8F-readme_locale_de_155">
  <img src="https://img.shields.io/badge/lesen%20-%20Deutsch%20-2b2b2b" alt="Deutsches README">
</a>
<a href="https://github.com/7n1m4/7n1m4#-readme_locale_pl_151">
  <img src="https://img.shields.io/badge/czytaj%20mnie-Polski%20-DC143C" alt="Polski README">
</a>
<a href="https://github.com/7n1m4/7n1m4#-readme_locale_kk_143">
  <img src="https://img.shields.io/badge/оқы-Қазақша%20-00A86B" alt="Қазақша README">
</a>
  <sub>
    <p><h2>
        AnimAIOS distro based on 
        <a href="https://endeavouros.com/" target="_blank">EndeavourOS</a>, on your Linux Desktop / Termux / CyberDeck / Wearable, this fall.
    </p>
    <p>
...
<a href="https://github.com/7n1m4/7n1m4/actions/workflows/ci.yml">
  <img src="https://github.com/7n1m4/7n1m4/actions/workflows/ci.yml/badge.svg" alt="CI">
</a>
...
- [x] **Brain**
  ...
  - [ ] _Multi-tier memory:_ [anima/vault](https://github.com/anlma/vault)
...
- [ ] **AnimAIOS (WIP)**
  ...
  - [ ] [anima/use-desktop](https://github.com/anima/use-desktop) deep integration
...
<a href="https://github.com/7n1m4/7n1m4#-readme_locale_kk_143">
  ...
  <p>
    <h2>
        ...
        ベースの AnimAIOS ディストリビューション。 この秋、あなたの Linux デスクトップ / Termux / サイバーデッキ / ウェアラブルへ。
    </p>
    <p>
...
* [x] **ブレイン**
  ...
  * [ ] *マルチティア・メモリー:* [anima/vault](https://github.com/anlma/vault)
...
* [ ] **AnimAIOS (WIP)**
  ...
  * [ ] [anima-use-desktop](https://github.com/anima/use-desktop) ディープインテグレーション
...
* [ ] [AnimaRouter](https://git.vi70.qzz.io/r) ベースのゲーミファイド・エナジーシステム。
...
<a href="https://github.com/7n1m4/7n1m4#-readme_locale_kk_143">
  ...
  <p>
    <h2>
        <a href="https://endeavouros.com/" target="_blank">EndeavourOS</a>
        기반 AnimAIOS 디스트로. 이번 가을, 너의 Linux 데스크탑 / Termux / 사이버덱 / 웨어러블로 ㄱㄱ.
    </p>
    <p>
        <a href="https://packages.cachyos.org/" target="_blank">CachyOS</a>
...
* [x] **브레인**
  ...
  * [ ] *멀티 티어 메모리:* [anima/vault](https://github.com/anlma/vault)
...
* [ ] **AnimAIOS (WIP)**
  ...
  * [ ] [anima-use-desktop](https://github.com/anima/use-desktop) 딥 인테그레이션
...
* [ ] [AnimaRouter](https://git.vi70.qzz.io/r) 기반 게이미파이드 에너지 시스템.
...
* [x] **Brain（大脑）**
  ...
  * [ ] *Multi-tier Memory:* [anima/vault](https://github.com/anlma/vault)
...
* [ ] **AnimAIOS (WIP)**
  ...
  * [ ] [anima-use-desktop](https://github.com/anima/use-desktop) 深度 Integration
...
* [ ] 基于 [AnimaRouter](https://git.vi70.qzz.io/r) 的 Gamified Energy System。
...
<a href="https://github.com/7n1m4/7n1m4#-readme_locale_kk_143">
  ...
  <sub>
    ...
    <h2>
        ...
        <a href="https://endeavouros.com/" target="_blank">EndeavourOS</a>, pro seu Desktop Linux / Termux / CyberDeck / Wearable, chegando neste outono.
    </p>
    <p>
...
<a href="https://github.com/7n1m4/7n1m4#-readme_locale_kk_143">
  ...
  <sub>
    ...
    <h2>
        ...
        <a href="https://endeavouros.com/" target="_blank">EndeavourOS</a>, pour ton Desktop Linux / Termux / CyberDeck / Wearable, cet automne.
    </p>
    <p>
...
- [x] **Cerveau**
  ...
  - [ ] _Mémoire multi-niveaux :_ [anima/vault](https://github.com/anlma/vault)
...
- [ ] **AnimAIOS (WIP)**
  ...
  - [ ] Intégration poussée de [anima-use-desktop](https://github.com/anima/use-desktop)
...
* [x] **Мозг**
  ...
  * [ ] *Многоуровневая память:* [anima/vault](https://github.com/anlma/vault)
...
* [ ] **AnimAIOS (WIP)**
  ...
  * [ ] Глубокая интеграция с [anima-use-desktop](https://github.com/anima/use-desktop)
...
* [ ] Основанная на [AnimaRouter](https://git.vi70.qzz.io/r) геймифицированная energy-система, которая заменит официальный AIRI provider — бесконечный источник бесплатных вкусных токенов для всех твоих cyber waifu LLM и Embedding нужд~ Или просто клонируй AnimaRouter и хости сам через BYOK! UI позволит легко переключаться между hosted/local AnimaRouter провайдерами!
...
* [x] **Gehirn 🧠**
  ...
  * [ ] *Mehrstufiges Gedächtnis:* anima/vault
...
* [ ] [AnimaRouter](https://git.vi70.qzz.io/r)
...
* [x] **Mózg 🧠**
  ...
  * [ ] *Pamięć wielopoziomowa:* anima/vault
