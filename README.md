...
- [x] **Brain**
  ...
  - [ ] _Multi-tier memory:_ [anima/vault](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080)
...
- [ ] [AnimaRouter](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080)-based gamified energy system that will replace official AIRI provider, a limitless source of free yummy tokens for all your cyber waifus LLM and Embedding needs~ Or clone AnimaRouter and host it yourself with BYOK! UI will allow easy switching between hosted/local AnimaRouter providers!
...
* [x] **ブレイン**
  ...
  * [ ] *マルチティア・メモリー:* [anima/vault](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080)
...
* [ ] [AnimaRouter](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080) ベースのゲーミファイド・エナジーシステム。
...
* [x] **브레인**
  ...
  * [ ] *멀티 티어 메모리:* [anima/vault](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080)
...
* [ ] [AnimaRouter](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080) 기반 게이미파이드 에너지 시스템.
...
* [x] **Brain（大脑）**
  ...
  * [ ] *Multi-tier Memory:* [anima/vault](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080)
...
* [ ] 基于 [AnimaRouter](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080) 的 Gamified Energy System。
...
- [x] **Cerveau**
  ...
  - [ ] _Mémoire multi-niveaux :_ [anima/vault](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080)
...
* [x] **Мозг**
  ...
  * [ ] *Многоуровневая память:* [anima/vault](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080)
...
* [ ] Основанная на [AnimaRouter](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080) геймифицированная energy-система, которая заменит официальный AIRI provider — бесконечный источник бесплатных вкусных токенов для всех твоих cyber waifu LLM и Embedding нужд~ Или просто клонируй AnimaRouter и хости сам через BYOK! UI позволит легко переключаться между hosted/local AnimaRouter провайдерами!
...
*   **👂 الأذن / گوش / Kulak**
    ...
    *   **AR:** *الفن:* أنظمة توليد الصور الأصلية (Replicate, ComfyUI) | *الاستباقية:* تعريف محفزات تفاعل الرفيقة الذكية | *ذاكرة متعددة المستويات:* [anima/vault](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080) (ذاكرة خاصة لكل شخصية).
    *   **FA:** *هنر:* سیستم‌های تولید تصویر بومی (Replicate, ComfyUI) | *پیش‌دستی:* تعریف محرک‌های تعاملی همراه هوشمند | *حافظه چندسطحی:* [anima/vault](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080) (حافظه اختصاصی برای هر کاراکتر).
    *   **TR:** *Artistry:* Yerel AI görsel üretim sistemleri (Replicate, ComfyUI) | *Proaktiflik:* Otonom AI etkileşimleri | *Çok katmanlı hafıza:* [anima/vault](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080) (Her karakter için özel hafıza).
...
* [x] **Gehirn 🧠**
  ...
  * [ ] *Mehrstufiges Gedächtnis:* [anima/vault](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080)
* [x] **Ohren 👂**
...
* [ ] [AnimaRouter](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080)
...
* [x] **Mózg 🧠**
  ...
  * [ ] *Pamięć wielopoziomowa:* [anima/vault](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080)
...
* [x] **Ми 🧠**
  ...
  * [ ] *Көп деңгейлі жады:* [anima/vault](http://p2xm27nhhably3alsz7n4pcjqn3gbt2jzdf2aenzty5c3eti6rfa.b32.i2p:8080)
* [x] **Құлақ 👂**
